...
<?php if( get_theme_mod('tanawul_bakery_slider_arrows') != ''){ ?>
  ...
  <img src="<?php echo esc_html(get_template_directory_uri() . '/assets/images/design2.png');?>" class="slider-design">
<?php }?>
  ...
  <section id="we-offer">
    <div class="container">      
      ...
      <?php if( get_theme_mod('tanawul_bakery_we_offer_title') != ''){ ?>
        ...
        <img src="<?php echo esc_html(get_template_directory_uri() . '/assets/images/titledesign.png');?>" class="title-design">
      <?php }?>
      <div class="row">
        <?php 
